 ...
 * Generated at: 2019-01-15 13:44:31 UTC
...
public final class content_002dcategory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\tvar v=tree.tree(\"isLeaf\",node.target);\r\n");
      out.write("\t\tif(!v){\r\n");
      out.write("\t\t\t$.messager.alert('错误','这个是文件夹包含子文件不能删除','warning');\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\telse{\r\n");
      out.write("\t\t\t$.messager.confirm('确认','确定删除名为 '+node.text+' 的分类吗？',function(r){\r\n");
      out.write("\t\t\t\tif(r){\r\n");
      out.write("\t\t\t\t\tvar parent=tree.tree(\"getParent\",node.target);\r\n");
      out.write("\t\t\t\t\talert(parent.id)\r\n");
      out.write("\t\t\t\t\t$.post(\"/content/category/delete\",{id:node.id,parentId:parent.id},function(){\r\n");
